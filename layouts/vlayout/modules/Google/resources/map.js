 ...
 *************************************************************************************/   
    jQuery.Class("MapView",{
        ...
        getStaticMapURL : function (address,size){
            ...
            var url=" http://maps.googleapis.com/maps/api/staticmap?size="+size+"&key=AIzaSyBpzml8fkdXoGrRFEDU3aW79Ql9UpOgOfU&maptype=roadmap&markers=size:mid%7Ccolor:red%7C"+encoded_address+"&sensor=false";
            return url;
        } ,
